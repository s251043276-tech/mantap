...
:::: {.columns}
::: {.column width="50%"}
### Control Chart for Part Length (Machine 1, 200kPa, 338K)

This Individual Control Chart monitors 'PartLength' for Machine 1 under specific conditions (Pressure = 200kPa, Temperature = 338K). It helps to identify if the process is stable and within control limits for this specific operational setting.
:::
...
:::: {.columns}
::: {.column width="50%"}
### Process Capability Analysis for Part Length (Machine 1, 200kPa, 338K)

This chart assesses the process capability for 'PartLength' under specific conditions (Machine 1, Pressure = 200kPa, Temperature = 338K) against the given specifications: Target = 50, LSL = 45, USL = 55. It helps determine if the process is capable of consistently producing parts within these limits.
:::

::: {.column width="50%"}
<iframe data-src='media/plots/partlength_capability_filtered.html' width='100%' height='500px' style='border:none;'></iframe>
:::
::::
...
::: {.column width="50%"}
<iframe data-src='media/plots/machine1_partlength_xbar_one_chart.html' width='100%' height='500px' style='border:none;'></iframe>
:::
::::
